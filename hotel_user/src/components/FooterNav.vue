...
const navItems = [
  { key: 'home', icon: 'home-o', text: '首页', path: '/', activeNames: ['Room', 'admin'] },
  { key: 'level', icon: 'medal-o', text: '评价', path: '/evaluation', activeNames: ['Evaluation'] },
  { key: 'mine', icon: 'user-o', text: '我的', path: '/home', activeNames: ['Home'] }
]
